...
<html lang="id">
    <head>
        ...
        <link rel="stylesheet" href="styleKetenagakerjaan.css">
    ...
    <body>
        <div class="header">
            <nav>
                ...
                <div class="nav-links" id="navLinks" onclick="clickMenu();">
                    ...
                    <ul class="menu-menu">
                        ...
                        <!-- <li><a href="Ha" onclick="clickMenu();">Ketenagakerjaan</a></li>
            ...
            <div class="text-box">
                <img src="foto/coverKetenagakerjaan.png" width="265.3px">
